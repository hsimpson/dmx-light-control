...
export type AddProject3dObjectInput = {
...
export type AddProjectFixtureInput = {
...
export type ImportFixtureAssignmentInput = {
  ...
  channelDefinitionName?: string | null | undefined;
  /** The public ID of the assigned channel definition in this fixture */
  channelDefinitionPublicId?: string | null | undefined;
...
export type ImportFixtureDefinitionInput = {
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
  ...
  ranges: Array<ImportFixtureRangeInput>;
  /** The date and time when the entity was last updated */
  updatedAt?: Date | null | undefined;
};
...
export type ImportFixtureInput = {
  ...
  channelModes: Array<ImportFixtureModeInput>;
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
  /** Fixture height in meters */
  height?: number | null | undefined;
  ...
  model3dPath?: string | null | undefined;
  /** The name of the fixture */
  name: string;
  /** 2D plot symbol path relative to the API origin */
  picture2dPath?: string | null | undefined;
...
export type ImportFixtureModeInput = {
  /** The channel assignments of the channel mode */
  assignments: Array<ImportFixtureAssignmentInput>;
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
...
export type ImportFixtureRangeInput = {
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
...
export type ImportFixtureVendorInput = {
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
...
export type ImportFixturesInput = {
  /** The fixtures to import */
  fixtures: Array<ImportFixtureInput>;
  /** The fixture export document schema version */
  schemaVersion: number;
  /** Fixture vendors to upsert, including those without fixtures */
  vendors?: Array<ImportFixtureVendorInput> | null | undefined;
};

export type ImportProject3dObjectInput = {
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
...
export type ImportProjectFixtureInput = {
  /** The public ID of the channel mode */
  channelModePublicId: string;
  /** The date and time when the entity was created */
  createdAt?: Date | null | undefined;
...
export type ImportProjectInput = {
  ...
  environmentType?: ProjectEnvironmentType | null | undefined;
  /** The name of the project */
  name: string;
  /** The 3D scene objects placed in this project */
  project3dObjects?: Array<ImportProject3dObjectInput> | null | undefined;
  /** The fixture instances patched into this project */
  projectFixtures?: Array<ImportProjectFixtureInput> | null | undefined;
  /** The public ID of the project */
  publicId?: string | null | undefined;
  /** Room height in meters */
  roomHeight?: number | null | undefined;
  /** Room length in meters */
  roomLength?: number | null | undefined;
...
export type ImportProjectsInput = {
  ...
  projects: Array<ImportProjectInput>;
...
export type UpdateProject3dObjectInput = {
...
export type UpdateProjectFixtureInput = {
  /** The public ID of the channel mode */
  channelModePublicId?: string | null | undefined;
  /** The public ID of the project fixture instance */
  publicId: string;
  /** The DMX start address (1–512) */
