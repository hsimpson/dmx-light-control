...
**Package manager:** `pnpm` (used for `pnpm install` and other pnpm tasks). **Node:** 24.21.0. **pnpm:** 12.5.1 (exact pin in `packageManager` / `devEngines`; bump both when upgrading).
